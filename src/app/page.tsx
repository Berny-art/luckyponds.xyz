...
export default function ReferralPage() {
	...
	return (
		<div className="mx-auto flex min-h-[70vh] max-w-xl flex-col items-center justify-center gap-6 p-4">
				...
				{!isConnected ? (
					...
					<div className="flex w-full flex-col gap-4">
						<div className="flex w-full flex-col gap-4 rounded-md border-2 border-primary-200 bg-primary-200/10 p-4">
							...
							<Button
								onClick={() => handleCopy(referralLink)}
								className="w-full animate-gradient bg-[linear-gradient(90deg,#F2E718_0%,#80E8A9_20%,#9353ED_50%,#ED5353_75%,#EDA553_100%)] font-bold font-mono text-white hover:bg-drip-300/70"
							>
			...
			{/* Error message */}
			{error && (
				<div className="w-full rounded-md border-2 border-red-500 bg-red-500/10 p-4">
